...
[$RootKey$\KeyBindingTables\{0c3d2821-ac98-416f-9a44-925e7cb866ad}]
@="#1"
...
ispcSyntaxUI.vsct, to work correctly so that the appropriate command handler below will be
called.
...
class EditorDocument : 
	...
	public IDispatchImpl<ISingleViewEditor, &__uuidof(ISingleViewEditor), &LIBID_ispcSyntaxLib>,
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_ispcSyntaxCmdSet, commandIDStrike, &OnQueryStrikeOut, &OnStrikeOut)
...
// Data members
	...
	VsMacroRecorder<&CLSID_ispcSyntaxEditorDocument, LastMacro, eLastMacroNone> m_Recorder;
