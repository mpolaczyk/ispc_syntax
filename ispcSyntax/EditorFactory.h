...
/***************************************************************************
ispcSyntax.pkgdef contains:


[$RootKey$\Editors\{1988e01f-238e-496a-be04-642bd888cf1f}]
@="ispcSyntax"
"Package"="{3b336d5e-3d60-42d6-81f1-b0f26baec137}"
"DisplayName"="ispcSyntax"
"ExcludeDefTextEditor"=dword:00000001
"AcceptBinaryFiles"=dword:00000000

[$RootKey$\Editors\{1988e01f-238e-496a-be04-642bd888cf1f}\LogicalViews]
"{7651A703-06E5-11D1-8EBD-00A0C90F26EA}"=""

[$RootKey$\Editors\{1988e01f-238e-496a-be04-642bd888cf1f}\Extensions]
"ispcSyntax"=dword:00000032

which informs the shell that ispcSyntaxPackage is the package to create to have this editor 
registered with Visual Studio.  When ispcSyntaxPackage is sited by Visual Studio, 
ispcSyntaxPackage::PostSited creates an instance of EditorFactory and then queries
...
#pragma warning(pop)
		...
		VSEDITORCREATEDOCWIN& /*rCreateDocumentWindowUI*/)
	{
		if(physicalViewId == Primary)
		{
			...
			rpguidCommandUI = &CLSID_ispcSyntaxEditorDocument;
